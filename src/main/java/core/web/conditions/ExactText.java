...
public class ExactText extends Condition {
    ...
    public ExactText(By elementBy, String elementText, boolean shouldBe) {
        this.elementBy = elementBy;
        this.elementText = elementText;
        this.shouldBe = shouldBe;
    }

    public ExactText(WebElement element, String elementText, boolean shouldBe) {
        ...
        try {
            return wait.until(d -> {
                        try {
                            ...
                            return shouldBe == uiElementText.get().equals(elementText);
