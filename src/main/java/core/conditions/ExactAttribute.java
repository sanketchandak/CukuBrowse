...
public class ExactAttribute extends Condition {
    ...
    public ExactAttribute(By elementBy, String attributeName, String attributeValue) {
        this.elementBy = elementBy;
        this.attributeName = attributeName;
        this.attributeValue = attributeValue;
    }

    public ExactAttribute(WebElement element, String attributeName, String attributeValue) {
