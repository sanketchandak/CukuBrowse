...
public class GetAttribute {
    ...
    public String getAttribute(WebElement element, String attribute) {
        ...
        logger.info(String.format("Get Attribute: Attribute: '%s' of element: '%s' having value as '%s'", attribute, element.toString(), retrievedAttributeValue));
        return retrievedAttributeValue;
    }
    ...
    public Map<String, String> getAttributes(WebElement element, List<String> attributes) {
        ...
        logger.info(String.format("Get Attributes: Attribute: '%s' of element: '%s' having values as '%s'", attributes, element.toString(), retrievedAttributesValues));
        return retrievedAttributesValues;
    }
}
