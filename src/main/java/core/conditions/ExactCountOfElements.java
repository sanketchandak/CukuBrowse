...
public class ExactCountOfElements extends Condition {
    WebDriver driver;
    private WebDriverWait wait;
    private final By elementBy;
    private final int elementCount;

    public ExactCountOfElements(By elementBy, int elementCount) {
    ...
    private boolean checkCondition() {
        return wait.until(ExpectedConditions.numberOfElementsToBe(elementBy, elementCount))!=null ? Boolean.TRUE : Boolean.FALSE;
    }
}
