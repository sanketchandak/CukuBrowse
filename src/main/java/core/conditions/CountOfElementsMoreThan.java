...
public class CountOfElementsMoreThan extends Condition {
    WebDriver driver;
    private WebDriverWait wait;
    private final By elementBy;
    private final int elementCount;

    public CountOfElementsMoreThan(By elementBy, int elementCount) {
    ...
    private boolean checkCondition() {
        return wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(elementBy, elementCount))!=null ? Boolean.TRUE : Boolean.FALSE;
    }
}
