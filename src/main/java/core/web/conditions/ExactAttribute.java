...
public class ExactAttribute extends Condition {
    WebDriver driver;
    ...
    public ExactAttribute(By elementBy, String attributeName, String attributeValue, boolean shouldBe) {
    ...
    public ExactAttribute(WebElement element, String attributeName, String attributeValue, boolean shouldBe) {
    ...
    private boolean checkCondition(){
        if (elementBy != null) {
            return wait.until(ExpectedConditions.attributeToBe(elementBy, attributeName, attributeValue));
        } else {
