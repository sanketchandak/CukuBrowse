...
public class NotContainsAttribute extends Condition {
    WebDriver driver;
    ...
    public NotContainsAttribute(By elementBy, String attributeName, String attributeValue) {
        this.elementBy = elementBy;
        this.attributeName = attributeName;
        this.attributeValue = attributeValue;
    }

    public NotContainsAttribute(WebElement element, String attributeName, String attributeValue) {
    ...
    private boolean checkCondition(){
        if (elementBy != null) {
            return wait.until(ExpectedConditions.not(
                    ExpectedConditions.attributeContains(elementBy, attributeName, attributeValue))
            );
        } else {
            return wait.until(ExpectedConditions.not(
                    ExpectedConditions.attributeContains(element, attributeName, attributeValue))
            );
        }
    }
}
